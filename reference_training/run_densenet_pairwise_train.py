...
from cattle_reid_gate0.densenet_pairwise import pairwise_loss
...
def source_binding():
    ...
    files += [project / 'scripts' / name for name in ('run_densenet_pairwise_train.py',
...
def main():
    ...
    require(release['operation'] == 'densenet-pairwise-train-v2' and release['training_allowed'] is True,
    ...
    require(str(args.output.resolve()).startswith('/q1/cattle-reid/densenet-pairwise-v2/'), 'persistent output required')
    ...
    publish_once(job / 'completion.json', signed(dict(release_sha256=args.pin,
        ...
        pool_type='gap', objective='query-support-pairwise-v2', temperature=0.1,
